...
As of 27 Oct 2016, both the ARM and Motherlode data sources also support the download and storing of the model wind speed and direction profile.  The lowest data point for these profiles should be 10 m AGL, and any missing data is stored in the output netCDF file as the masked or missing field.  NOTE: The model U and V components are linearly interpolated to a much finer grid before calculating the wind speed and direction.
